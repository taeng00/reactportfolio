...
// Work 컴포넌트는 직무 경험을 표시하기 위한 함수형 컴포넌트입니다.
function Work({ position, company, location, type, duration }) {
  return (
    // 직무 경험을 감싸는 article 요소입니다. 상단에는 보더가 있고, dark 모드에서는 스타일이 다릅니다.
