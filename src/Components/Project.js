...
// Project 컴포넌트는 각각의 프로젝트 정보를 표시하는 UI를 생성합니다.
        ...
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            <svg
              ...
              viewBox="0 0 20 20"
              fill="none"
              xmlns="http://www.w3.org/2000/svg" //Scalable Vector Graphics (SVG)를 위한 XML 네임스페이스(Namespaces)입니다. 
              // SVG는 XML 기반의 벡터 이미지를 생성하고 표현하기 위한 표준 포맷으로, 웹 페이지나 애플리케이션에서 그래픽 요소를 정의하고 표현하는 데 사용
            >
              <path
